...
pipeline {
    ...
    stages {
        ...
        stage('docker compose') {
            steps {
                withSecrets(config: [connectCredentialId: '1pass_jenkins_token', connectHost: 'http:\\\\localhost:8080', opCLIPath: '/home/ahesh-19540/software/op'], secrets: [[envVar: 'PORT', secretRef: 'op://jenkins_provider/server_credential/port']]) {
                    sh 'echo $PORT'
                }
            }
        }
